const { createApp } = Vue;
    createApp({
        data() {
            ...
            fetch('employer_messages?action=contacts')
                .then(res => res.json())
                .then(data => {
        ...
        methods: {
            ...
            async sendMessage() {
                try {
                  ...
                  const response = await fetch('employer_messages?action=send', {
                    method: 'POST',
            ...
            markAsRead(message) {
                fetch('employer_messages?action=markRead', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        ...
        fetchMessages() {
            fetch('employer_messages?action=list')
                .then(res => res.json())
                .then(data => {
                    if (data.success) {
            ...
            moveToFolder(msg, folder, successMessage) {
                fetch('employer_messages?action=updateFolder', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            ...
            toggleImportant(msg) {
                ...
                const newFolder = isImportant ? (msg.receiver_email === this.employerProfile.email ? 'inbox' : 'sent') : 'important';
            ...
            restoreFromTrash(msg) {
                ...
                const newFolder = msg.receiver_email === this.employerProfile.email ? 'inbox' : 'sent';
