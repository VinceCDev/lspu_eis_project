        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden animate-slide-in">
            ...
            <div class="px-6 pb-6">
                ...
                <form @submit.prevent="submitForgot" class="space-y-4">
                    ...
                    <button type="submit" class="w-full px-4 py-2.5 bg-lspu-blue hover:bg-lspu-dark text-white font-semibold rounded-lg shadow-md transition duration-300 flex items-center justify-center gap-2" :disabled="isLoading">
