...
<div class="bg-white dark:bg-gray-700 rounded-xl shadow-sm p-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
        ...
        <div class="flex flex-col sm:flex-row flex-wrap gap-2 w-full md:w-auto">
            ...
            <select v-if="isSuperadmin" class="form-select px-3 py-2 rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-100 w-full sm:w-auto" v-model="filters.campus">
                <option value="">All Campuses</option>
                <option v-for="campus in uniqueCampuses" :key="campus">{{ campus }}</option>
            </select>
        </div>
    </div>
    ...
    <div class="px-6 py-6">
      ...
      <div class="mb-6">
        ...
        <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 shadow-sm">
          <a v-if="selectedApplicant.alumni && selectedApplicant.alumni.resume_file" :href="'uploads/resumes/' + selectedApplicant.alumni.resume_file" target="_blank" class="inline-flex items-center gap-2 text-blue-700 dark:text-blue-300 underline">
