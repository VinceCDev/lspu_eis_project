                ...
                <tr v-for="account in paginatedAccounts" :key="account.user_id" class="border-b border-gray-200 dark:border-gray-600">
                    ...
                    <td class="px-4 py-2 text-center">
                        <div class="relative inline-block text-left">
                            ...
                            <teleport to="body">
                                <div v-if="actionDropdown === account.user_id" class="teleported-action-dropdown fixed w-32 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 z-[300]" :style="{ top: dropdownPosition.top + 'px', left: dropdownPosition.left + 'px' }">
