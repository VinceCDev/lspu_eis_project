...
/** Ported from backend/Controllers/Admin/NotificationController.php. */
class NotificationController extends Controller
{
    public function index()
    {
        return view('admin.notification', [
            ...
            'active' => Auth::role() === 'superadmin' ? 'superadmin_notification' : 'admin_notification',
            'pageJs' => 'admin_notification.js',
        ]);
    }
